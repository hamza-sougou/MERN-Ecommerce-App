...
const Cart = () => {
  ...
  return (
    <div className="flex justify-around items-start flex-wrap px-[1rem] md:px-[10rem] mt-8">
      {cartItems.length === 0 ? (
        <div>
          ...
          <div className="flex flex-col w-full">
            ...
            <div className="mt-8">
              <div className="p-4 rounded-lg">
                ...
                <button
                  className="bg-orange-500 mt-4 py-2 px-4 rounded text-lg text-white w-full md:w-[40%] "
